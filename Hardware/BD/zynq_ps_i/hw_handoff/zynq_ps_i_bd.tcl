...
proc create_root_design { parentCell } {
  ...
  set pkt_size_out_0 [ create_bd_port -dir O -from 31 -to 0 pkt_size_out_0 ]
  ...
  connect_bd_net -net pkt_gen_controller_0_pkt_size_out [get_bd_ports pkt_size_out_0] [get_bd_pins pkt_gen_controller_0/pkt_size_out]
