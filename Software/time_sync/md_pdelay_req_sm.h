...
void init_md_pdelay_req_sm(MDPdelayReqSM *sm, PerPortGlobal *per_port_global, PerPTPInstanceGlobal *per_ptp_instance_global, MDEntityGlobal *md_entity_global);
void test_md_pdelay_req_sm_send(MDPdelayReqSM *sm);
void md_pdelay_req_sm_run(MDPdelayReqSM *sm, UScaledNs ts);
void md_pdelay_req_sm_txts(MDPdelayReqSM *sm, UScaledNs ts, TSUTimestamp tsuTimestamp);
void md_pdelay_req_sm_recv_resp(MDPdelayReqSM *sm, UScaledNs ts, TSUTimestamp *tsuTimestamp, PTPMsgPdelayResp *pdelayRespPtr);
void md_pdelay_req_sm_recv_resp_follow_up(MDPdelayReqSM *sm, UScaledNs ts, PTPMsgPdelayRespFollowUp *pdelayRespFollowupPtr);
